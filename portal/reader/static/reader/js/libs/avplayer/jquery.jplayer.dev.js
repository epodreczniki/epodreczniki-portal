    ...
    b.jPlayer.prototype = {
        ...
        _init: function () {
            ...
            this.internal.poster.jq.css({
                width: "100%", //this.status.width,
                height: "100%" //this.status.height
            });
            ...
            if (this.status.noVolume) {
                this.css.jq.progressbar.addClass('jp-progressbar-novolume');
                this.css.jq.gui.find('.jp-settings').addClass('jp-settings-novolume');
                //this.css.jq.settingsbar.addClass('jp-settings-novolume');
            }
        },
        destroy: function () {
            this.clearMedia();
        ...
        play: function (a) {
            var v = this.htmlElement.media;


            var canPlay = true;
            var guiVisible = this.css.jq.gui.is(":visible");
            if (typeof this.options.canPlayCallback === "function") {
                canPlay = this.options.canPlayCallback(this.status.src, this.options.container);
            }

            if (!this.options.simpleAudioMode && !guiVisible) {
            ...
            if (canPlay) {
                console.log('Play URL:' + this.status.src);
        ...
        _updateAutohide: function () {
            ...
            var a = this,
                c = function (event) {
                    var cp = event.pageX + ',' + event.pageY;
                    if (cp != pp && !a.options.errorState) {
                        pp = cp;
                        event.stopImmediatePropagation();
                        a.css.jq.gui.fadeIn(a.options.autohide.fadeIn, function () {
                            clearTimeout(a.internal.autohideId);
                            a.internal.autohideId = setTimeout(function () {
                                a.css.jq.gui.fadeOut(a.options.autohide.fadeOut, function () {  })
            ...
            function showGui()
            {
                if (!a.options.errorState) {
                    a.css.jq.gui.show();
                }
            }

            this.css.jq.gui.length && (this.css.jq.gui.stop(!0, !0), clearTimeout(this.internal.autohideId), this.element.unbind(".jPlayerAutohide"), this.css.jq.gui.unbind(".jPlayerAutohide"), this.css.jq.videoPlay.unbind(".jPlayerAutohide", c), this.status.nativeVideoControls
                ? this.css.jq.gui.hide()
                : this.options.fullWindow && this.options.autohide.full || !this.options.fullWindow && this.options.autohide.restored
                        ? (this.element.bind("mousemove.jPlayer.jPlayerAutohide", c), this.css.jq.gui.bind("mousemove.jPlayer.jPlayerAutohide", c), this.css.jq.videoPlay.bind("mousemove.jPlayer.jPlayerAutohide", c), this.css.jq.gui.hide())
                        : showGui())
        },
        fullScreen: function () {
        ...
        _html_initMedia: function (a) {
            ...
            if (v.textTracks && v.textTracks.length == 0 && a.track && a.track.length > 0) {
