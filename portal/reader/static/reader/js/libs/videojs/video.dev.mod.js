...
vjs.MenuButton.prototype.removeInlineDisplay = function(){
    var qMenu = $(this.el_).find('.vjs-menu');
    if(qMenu.attr("style") !== undefined){
       qMenu.removeAttr("style");
