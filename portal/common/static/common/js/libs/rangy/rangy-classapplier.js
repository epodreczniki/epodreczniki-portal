...
(function(factory, root) {
    ...
    rangy.createModule("ClassApplier", ["WrappedSelection"], function(api, module) {
        ...
        //MIJN SHIJT
        var ign = function(node){
            while(node){
                if(node.nodeType===1 &&  checkElement(node)){
                //if(node.nodeType===1 && hasClass(node,"notes-ignored")){
                    return node; 
                }
        ...
        ClassApplier.prototype = {
            ...
            isIgnorableWhiteSpaceNode: function(node) {
                return ign(node) || (this.ignoreWhiteSpace && node && node.nodeType == 3 && isUnrenderedWhiteSpaceNode(node));
            },
    ...
    console.log("css class applier DONE");
    return rangy;
}, this);
